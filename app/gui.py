...
def show_graph_shortest_path(g, shortest_path_node, pos):
    ...
    for i in range(len(shortest_path_node) - 1):
        shortest_path_edge = [shortest_path_node[i], shortest_path_node[i + 1]]
    ...
    nx.draw_networkx_edges(g, pos, edgelist=shortest_path_edges, arrows=False, label=labels, width=8, alpha=0.5,
                           edge_color="r")
